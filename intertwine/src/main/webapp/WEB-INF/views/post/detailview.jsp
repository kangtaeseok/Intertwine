                    ...
                    <div class="box"style="display: flex;margin-top: 5px;margin-bottom: 3px;">
                         <div class="reaction" id="reaction" style=" position: relative;cursor: pointer;">
                              ...
                              <form action="updatereaction.do" method="post" id="reactionForm">
	                              ...
	                              <div class="reaction-box" id="reaction-box" style="display: none;position: absolute;top: 120%;left: 50%;transform: translateX(-50%);background-color: #fff;border-radius: 5px;box-shadow: 0 2px 5px rgba(0, 0, 0, 0.2);padding: 10px;z-index: 5;flex-direction: row;align-items: center; justify-content: center;width: auto;flex-wrap: wrap;">
	                                 ...
	                                 <c:if test="${ not empty whatIsLiked }">
	                                   ...
	                                   <button type="submit" name="likeType" value="0" class="reaction-button" style="border: none; background: none;">
						                    <i class="fa-regular fa-thumbs-up" style="font-size: 30px; padding-left: 7px;padding-bottom:5px;"></i>
						                </button>
	                                   </c:if>
	                                   <c:if test="${ whatIsLiked eq '0' }">
	                                   <button type="submit" name="likeType" value="0" class="reaction-button" style="border: none; background: none;">
						                    <i class="fa-solid fa-thumbs-up" style="font-size: 30px; padding-left: 7px;padding-bottom:5px;"></i>
						                </button>
	                                   </c:if>
	                                   ...
	                                   <button type="submit" name="likeType" value="1" class="reaction-button" style="border: none; background: none;">
						                    <i class="fa-regular fa-heart" style="font-size: 30px; padding-left: 7px;padding-bottom:5px;"></i>
						                </button>
	                                   </c:if>
	                                   <c:if test="${ whatIsLiked eq '1' }">
	                                   <button type="submit" name="likeType" value="1" class="reaction-button" style="border: none; background: none;">
						                    <i class="fa-solid fa-heart" style="font-size: 30px; padding-left: 7px;padding-bottom:5px;"></i>
						                </button>
	                                   </c:if>
	                                   ...
	                                   <button type="submit" name="likeType" value="2" class="reaction-button" style="border: none; background: none;">
						                    <i class="fa-regular fa-face-sad-tear" style="font-size: 30px; padding-left: 7px;padding-bottom:5px;"></i>
						                </button>
	                                   </c:if>
	                                   <c:if test="${ whatIsLiked eq '2' }">
	                                  <button type="submit" name="likeType" value="2" class="reaction-button" style="border: none; background: none;">
						                    <i class="fa-solid fa-face-sad-tear" style="font-size: 30px; padding-left: 7px;padding-bottom:5px;"></i>
						                </button>
	                                   </c:if>
	                                   <c:if test="${ whatIsLiked ne '3' }">
	                                    <button type="submit" name="likeType" value="3" class="reaction-button" style="border: none; background: none;">
						                    <i class="fa-regular fa-face-angry" style="font-size: 30px; padding-left: 7px;padding-bottom:5px;"></i>
						                </button>
	                                   </c:if>
	                                   <c:if test="${ whatIsLiked eq '3' }">
	                                  <button type="submit" name="likeType" value="3" class="reaction-button" style="border: none; background: none;">
						                    <i class="fa-solid fa-face-angry" style="font-size: 30px; padding-left: 7px;padding-bottom:5px;"></i>
						                </button>
	                                   </c:if>
	                                   ...
	                                   <button type="submit" name="likeType" value="4" class="reaction-button" style="border: none; background: none;">
						                    <i class="fa-regular fa-face-laugh-squint" style="font-size: 30px; padding-left: 7px;padding-bottom:5px;"></i>
						                </button>
	                             	   </c:if>
		                               <c:if test="${ whatIsLiked eq '4' }">
		                                <button type="submit" name="likeType" value="4" class="reaction-button" style="border: none; background: none;">
						                    <i class="fa-solid fa-face-laugh-squint" style="font-size: 30px; padding-left: 7px;padding-bottom:5px;"></i>
						                </button>
		                               </c:if>
	                             	</c:if>
