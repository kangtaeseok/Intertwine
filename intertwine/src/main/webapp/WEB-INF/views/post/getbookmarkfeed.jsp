					...
					<div class="actionBtns">
						<div class="left">
							...
							document.addEventListener("DOMContentLoaded", function() {
								  // Assuming item.post.postId is unique for each share icon
								  var shareIcon = document.getElementById(`${item.post.postId}`);  // Use getElementById

								  if (shareIcon) {  // Check if the element exists
								    shareIcon.addEventListener('click', function(event) {
								      // Get the clicked element (the specific share icon)
								      const clickedIcon = event.target;

								      // Get the post ID from the clicked icon's ID
